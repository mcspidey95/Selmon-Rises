...
namespace Hevadea
{
    public static class Game
    {
        ...
        public static readonly string Title = "Selmon Rises";
        public static readonly string SubTitle = "\"Will He Kill Another Deer?\"";
        public static readonly string Version = "0.6.9";
